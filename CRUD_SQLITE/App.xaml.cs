...
namespace CRUD_SQLITE
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            var queryClient = "CREATE TABLE IF NOT EXISTS MClients" +
            ...
            var queryProduct = "CREATE TABLE IF NOT EXISTS MProducts" +
            ...
            var queryCart = "CREATE TABLE IF NOT EXISTS MCart" +
                ...
                "CONSTRAINT  FK_Cart_Client FOREIGN  KEY(IdClient) REFERENCES  MClients(IdClient), " +
                "CONSTRAINT  FK_Cart_Product FOREIGN  KEY(IdProduct) REFERENCES  MProducts(IdProduct))";
            ...
            var queryCode = "CREATE TABLE IF NOT EXISTS  MCodeApp " +
                ...
                "PRIMARY KEY('IdCode' AUTOINCREMENT))";
            ...
            var queryDetailsCart = "CREATE TABLE IF NOT EXISTS MDetailsCart" +
                "(IdDetailsCart  INTEGER  NOT NULL, " +
                "IdCart  INTEGER  NOT NULL, " +
                ...
                "Total  REAL  NOT NULL, " +
                "PRIMARY KEY('IdDetailsCart' AUTOINCREMENT), " +
                "CONSTRAINT  FK_DetailsCart_Cart FOREIGN  KEY(IdCart) REFERENCES  MCart(IdCart))";
